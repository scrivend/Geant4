...
{
//COMMENTS BY SHUYA 160428!!! NOTE! THIS IS A BUG FROM their original source code (LXe). 
...
//by Shuya 160613. To test if PMT in backside is working.
//G4cout << "TEST 160613!!  " << pmtNumber << G4endl;
