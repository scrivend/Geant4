...
//////////////////////////// Comment By Shuya 160525. THIS IS TO CHANGE FOR SCINTILLATION MATERIALS (1/8) /////////////////////////////////
		...
		createHydrocarbon("LXe", 1.023*g/cm3, 1.100, fH, fC);
...
//Comment By Shuya 160512. Scintillation Yield: BC505=12000, BC519:9500, BC404=10400, EJ309=11500 (From Ejen catalogue). Anthracene~15000.
  ...
  fLXe_mt->AddConstProperty("SCINTILLATIONYIELD",(10400.*0.2)/MeV);
...
//by Shuya 160512 for BC404 (not sure about slow one)
  fLXe_mt->AddConstProperty("FASTTIMECONSTANT",1.8*ns);
...
void LXeDetectorConstruction::SetDefaults() {
  ...
  fD_mtl=0.0635*cm;
//by Shuya 160609. This is just for testing with an unrealistic value.
  //fD_mtl=0.0635*m;
...
//Comment By Shuya 160512. Scintillation Yield: BC505=12000, BC519:9500, BC404=10400, EJ309=11500 (From Ejen catalogue). Anthracene~15000.
  ...
  if(fLXe_mt)fLXe_mt->AddConstProperty("SCINTILLATIONYIELD",(10400.*0.2)/MeV);
