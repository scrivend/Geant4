...
class LXeMainVolume : public G4PVPlacement
{
  ...
  private:
    ...
    void PlacePMTs(G4LogicalVolume* pmt_Log,
		...
		//by Shuya 160609
                   G4double &x, G4double &y, G4double &z, G4int &k, G4LogicalVolume* pMotherVolume);

//by Shuya 160608.
    void PlacePMTs2(G4VSolid* pmt_Hollow,
                   G4RotationMatrix* rot,
                   G4double &a, G4double &b, G4double da,
                   G4double db, G4double amin, G4double bmin,
                   G4int na, G4int nb,
...
//by Shuya 160608
    G4Box* fPmt_hollow;
    //G4SubtractionSolid* hollowHousing_box;
    G4VSolid* hollowHousing_box;
