...
G4VPhysicalVolume* MDMDetectorConstruction::Construct() {
  ...
  if(fIsChamber) {
    ...
    G4VSolid* entranceSlitBox = new G4Box("entranceSlitBox",slitBoxDistance*tan(2*3.14159/180.),slitBoxDistance*tan(0.5*3.14159/180.),1.*mm);//4x1 for wide, 0.1x1 for single
