...
//by Shuya 161019. For 4*4 pmts. Be careful the unit is mm!! 
 // for(int i=16;i<32;i++)	G4cout << fPmtPositions[i] << G4endl;
...
void LXeMainVolume::VisAttributes(){
  G4VisAttributes* housing_va = new G4VisAttributes(G4Colour(0.8,0.0,0.8));
