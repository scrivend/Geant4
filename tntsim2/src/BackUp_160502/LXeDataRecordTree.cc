...
//by Shuya 160422.
/*
PmtFrontHit.resize(10);
for(int i=0;i<10;i++)	PmtFrontHit[i].resize(10);
PmtBackHit.resize(10);
for(int i=0;i<10;i++)	PmtBackHit[i].resize(10);
*/
...
//by Shuya 160407
  LXeEventTree->Branch("Num_PhotonFront",&eng_LXe_PhotonFront,"eng_LXe_PhotonFront/I");
//by Shuya 160427
  LXeEventTree->Branch("Num_PhotonBack",&eng_LXe_PhotonBack,"eng_LXe_PhotonBack/I");
//by Shuya 160502
  LXeEventTree->Branch("Num_PhotonTotal",&eng_LXe_PhotonTotal,"eng_LXe_PhotonTotal/I");
...
void LXeDataRecordTree::senddataPMT(int id, int value1, int evid)
{
	...
	{
        	sprintf(brN, "Count_PMT_Back_run%d",evid);
		x = (id-100) / 10;
		y = (id-100) % 10;
...
void LXeDataRecordTree::createdataPMT(int evid)
{
	char brN[300];
  	...
  	LXeEventTree2->Branch(brN,PmtFrontHit,"PmtFrontHit[10][10]/I");
  	...
  	LXeEventTree2->Branch(brN,PmtBackHit,"PmtBackHit[10][10]/I");
...
void LXeDataRecordTree::ShowDataFromEvent()
{
      ...
      G4cout << "The Position of the First Hit was (cm) (Distance from (x=0,y=0,z=0)):    " << FirstHitMag << G4endl;
      G4cout << "The Position of the First Hit was (cm) (x,y,z):    " << FirstHitPosition << G4endl;
...
void LXeDataRecordTree::FillTree2(int evid)
{
	...
	//for(int i=0;i<10;i++)
	//{
	//	for(int j=0;j<10;j++)	G4cout << PmtFrontHit[i][j] << G4endl;
	//}
	...
	//for(int i=0;i<10;i++)
	//{
	//	for(int j=0;j<10;j++)	G4cout << PmtBackHit[i][j] << G4endl;
	//}
