...
menate_R::menate_R(const G4String& processName) : G4VDiscreteProcess(processName)
{
  ...
  //Comment by Shuya 161020. However, it's always better to check each reaction's part because there are many exceptions....
  N_Tracking = 2;
...
void menate_R::ReadCrossSectionFile(G4String FileName, CrossSectionClass* theReactionXS)
{
 ...
 // 2/24/16 - BTR - directory where you find the cross sections.
	...
	//G4String DirName = G4String(LXE_SOURCE_DIR) + "/MENATEG4";
	//by Shuya 180516
	//G4String DirName = G4String("/home/gacgroup/shuyaota/Geant4/tntsim2") + "/MENATEG4";
	G4String DirName = G4String("/home/shuyaota/Geant4/tntsim2") + "/MENATEG4";
...
//NOTE!!! by Shuya 160420. Because I named BC505 as LXe to avoid complicated name-changing process...
//Likewise above, BC505 = CH_1.33 = 13.33
     else if(MaterialName == "LXe")
