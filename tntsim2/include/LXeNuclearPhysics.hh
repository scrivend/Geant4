...
//
//
#ifndef LXeNuclearPhysics_h
#define LXeNuclearPhysics_h 1
...
class LXeNuclearPhysics : public G4VPhysicsConstructor
{
  public:

    LXeNuclearPhysics(const G4String& name = "nuclear");
    virtual ~LXeNuclearPhysics();
